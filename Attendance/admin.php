...
$query2 = "SELECT COUNT(`name`) from `teachers`";
$result2 = mysqli_query($conn, $query2);
if ($result2) {
  foreach ($result2 as $key => $value) {
    foreach ($value as $key1 => $value1) {
      $total_teachers = $value1;
    }
  }
}
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li class="active"><a href="../admin.php">Dashboard</a></li>
          <li><a href="Admin/add&removeteacher.php">Add / Remove Teacher</a></li>
          <li><a href="Admin/add&removebranch.php">Add / Remove Branch</a></li>
          <li><a href="Admin/changepassword.php">Change password</a></li>
          <li><a href="Admin/showteachers.php">Show teachers</a></li>
          <li><a href="Admin/showbandh.php">Show Branches & Heads</a></li>
      ...
      <div class="col-sm-9">
        ...
        <div class="row">
          <div class="col-sm-7">
            <div class="well">
              <h5><b>Teachers</b>
                <button><a href="Admin/showteachers.php">Show all ></a></button>
              </h5>
              <hr>
              <table>
                <tr>
