    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li><a href="Teacher/addstudent.php">Add Student</a></li>
          <li><a href="Teacher/removestudent.php">Remove Student</a></li>
          <li><a href="Teacher/update.php">Update details</a></li>
      ...
      <div class="col-sm-9">
        ...
        <div class="row">
          <div class="col-sm-7">
            <div class="well">
              <h5><b>Students</b>
                <button><a href="Teacher/recordstudent.php">Show all ></a></button>
              </h5>
              <hr>
              <table>
                <tr>
